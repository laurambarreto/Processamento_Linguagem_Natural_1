...
def KNN_optuna (trial):
    ...
    KNN.fit (X_train_val_num_norm, y_train_val_num)
...
def KNN_modelo ():
    ...
    KNN.fit (X_train_num_norm, y_train_num)
    time_end = time.time()
...
def regressao_logistica_optuna (trial):
    ...
    log_reg.fit (X_train_val_num_norm, y_train_val_num)
...
def regressao_logistica ():
    ...
    # Medir tempo de treino
    time_start = time.time()
    log_reg.fit (X_train_num_norm, y_train_num)
    time_end = time.time()
...
def naive_bayes_optuna (trial):
    ...
    nb.fit (X_train_val_num_norm, y_train_val_num)
...
def naive_bayes_modelo ():
    ...
    # Medir tempo de treino
    time_start = time.time()
    nb.fit(X_train_num_norm, y_train_num)
    time_end = time.time()
...
def random_forest_optuna (trial):
    ...
    rf.fit(X_train_val_num_norm, y_train_val_num)
...
def random_forest_modelo ():
    ...
    # Medir tempo de treino
    time_start = time.time()
    rf.fit (X_train_num_norm, y_train_num)
    time_end = time.time()
...
def rede_neuronal_optuna (trial):
    ...
    rnn.fit (X_train_val_num_norm, y_train_val_num)
...
def rede_neuronal_modelo ():
    ...
    # Medir tempo de treino
    time_start = time.time()
    rnn.fit (X_train_num_norm, y_train_num)
    time_end = time.time()
